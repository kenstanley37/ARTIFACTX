...
using ArtifactX.Core; // Directly hooks your core decryption/decompression engine[cite: 2, 8]
using System;
using System.IO;
using System.Text;
...
namespace ArtifactX.WinUI3.Views.InspectionPages;
...
public sealed partial class HGDecryptionPage : Page
{
    ...
    private async void SelectFileBtn_Click(object sender, RoutedEventArgs e)
    {
        ...
        var window = ArtifactX.WinUI3.App.MainWindowInstance;
        if (window != null)
        {
