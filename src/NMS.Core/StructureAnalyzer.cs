...
public static class StructureAnalyzer
{
    ...
    public static void HuntJsonKeyAncestry(byte[] rawUncompressedJson, string searchTarget)
    {
        ...
        Console.WriteLine($"\n[NMS-STRUCTURE-ANALYZER] Initiating strict ancestry hunt for target: '{searchTarget}'");
        ...
        Console.WriteLine($"[NMS-STRUCTURE-ANALYZER] Completed scan. Total strict parent instances discovered: {matchCount}\n");
    }
